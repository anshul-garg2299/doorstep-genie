...
let requested = firebase.database().ref("requests/req");
...
requested.ref.once('value', gotData);
...
function gotData(data) {
    ...
    if (typeof gotData.counter == 'undefined') {
        gotData.counter = 0;
    }
    ...
    for (let i = 0; i < keys.length; i++) {
        ...
        let number = i + 1 + gotData.counter;
